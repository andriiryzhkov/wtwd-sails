...
В файлі `config/blueprints.js` задаємо параметри підключення до вашої бази даних. **Не забудьте вказати саме ваші логін та пароль, а також назву БД!**
...
```
Налаштування в файлі `config/blueprints.js`.
